            ...
            <form method="POST" action="{{ route('admin.categories.update', $category) }}">
                ...
                <div class="mb-6 p-4 bg-gray-50 rounded-md">
                    ...
                    <div class="text-sm text-gray-600">
                        <p>Services using this category: <strong>{{ $category->services()->count() }}</strong></p>
                        <p class="mt-1 text-xs text-gray-500">Note: Changing the category name will update the slug automatically</p>
                    </div>
                </div>
