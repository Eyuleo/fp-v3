                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('services.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="description" name="description" rows="5" class="block mt-1 w-full border-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded-md shadow-sm" required>{{ old('description') }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="tags" class="block mt-1 w-full" type="text" name="tags" :value="old('tags')" placeholder="e.g., web design, logo, branding" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="delivery_days" class="block mt-1 w-full" type="number" min="1" max="365" name="delivery_days" :value="old('delivery_days')" required />
